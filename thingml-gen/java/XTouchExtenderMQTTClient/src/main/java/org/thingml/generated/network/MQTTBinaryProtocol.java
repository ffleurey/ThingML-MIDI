...
if(msgName.equals(SLIDER.getName())){
...
else if(msgName.equals(BUTTON_PRESS.getName())){
...
if (e.getType().equals(BUTTON_LIGHT_ON)) {
...
;}
else if (e.getType().equals(BUTTON_LIGHT_OFF)) {
