...
uint8_t array_xtouch_XTouchExtender_XTouchExtenderSC_last_pot_var[8];
uint8_t array_xtouch_XTouchExtender_XTouchExtenderSC_last_slider_var[8];
...
XTouchExtender_handle_clock_timer_timeout(&xtouch_var, param_id);
...
void forward_XTouchExtender_send_clock_timer_cancel(struct XTouchExtender_Instance *_instance, uint8_t id){
if(_instance->id_clock == xtouch_var.id_clock) {
forward_Timer_XTouchExtender_send_clock_timer_cancel(_instance, id);
}
}
void forward_XTouchExtender_send_clock_timer_start(struct XTouchExtender_Instance *_instance, uint8_t id, uint32_t time){
if(_instance->id_clock == xtouch_var.id_clock) {
forward_Timer_XTouchExtender_send_clock_timer_start(_instance, id, time);
}
}
...
void forward_XTouchExtender_send_xtouch_pot_slow(struct XTouchExtender_Instance *_instance, uint8_t ch, uint8_t value){
if(_instance->id_xtouch == xtouch_var.id_xtouch) {
forward_MQTT_XTouchExtender_send_xtouch_pot_slow(_instance, ch, value);
}
}
...
void forward_XTouchExtender_send_xtouch_slider_slow(struct XTouchExtender_Instance *_instance, uint8_t ch, uint8_t value){
if(_instance->id_xtouch == xtouch_var.id_xtouch) {
forward_MQTT_XTouchExtender_send_xtouch_slider_slow(_instance, ch, value);
}
}
...
register_external_XTouchExtender_send_clock_timer_start_listener(&forward_XTouchExtender_send_clock_timer_start);
register_external_XTouchExtender_send_clock_timer_cancel_listener(&forward_XTouchExtender_send_clock_timer_cancel);
...
register_external_XTouchExtender_send_xtouch_slider_slow_listener(&forward_XTouchExtender_send_xtouch_slider_slow);
register_external_XTouchExtender_send_xtouch_pot_slow_listener(&forward_XTouchExtender_send_xtouch_pot_slow);
...
xtouch_var.id_clock = add_instance( (void*) &xtouch_var);
...
xtouch_var.XTouchExtender_XTouchExtenderSC_last_pot_var = array_xtouch_XTouchExtender_XTouchExtenderSC_last_pot_var;
xtouch_var.XTouchExtender_XTouchExtenderSC_last_pot_var_size = 8;
xtouch_var.XTouchExtender_XTouchExtenderSC_last_slider_var = array_xtouch_XTouchExtender_XTouchExtenderSC_last_slider_var;
xtouch_var.XTouchExtender_XTouchExtenderSC_last_slider_var_size = 8;
