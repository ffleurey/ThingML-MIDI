...
public Event instantiate(final int ch, final int id) { return new Button_pressMessage(this, ch, id); }
...
return "button_press (" + "ch: " + ch + ", " + "id: " + id + ")";
}

protected Button_pressMessage(EventType type, final int ch, final int id) {
super(type);
this.ch = ch;
this.id = id;
}
