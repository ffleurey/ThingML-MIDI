...
#define MIDIPARSER_MIDIECHOSC_STATE 0
#define MIDIPARSER_MIDIECHOSC_CTRLCHANGE_STATE 1
#define MIDIPARSER_MIDIECHOSC_PBENDCHANGE_STATE 2
#define MIDIPARSER_MIDIECHOSC_NOTEON_STATE 3
#define MIDIPARSER_MIDIECHOSC_WAITING_STATE 4
#define MIDIPARSER_MIDIECHOSC_NOTEOFF_STATE 5
